...
import com.zzy.travle.databinding.FragmentSpecialBathingBinding;

public class SpecialBathingFragment extends BaseFragment<FragmentSpecialBathingBinding> {

    public static final String TAG = "SpecialBathingFragment";
